  ...
  if (!cardName) {
    return (
      <div className="backdrop-blur rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-colors duration-300" style={cardStyle}>
        <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4" style={{ color: "var(--text-primary)" }}>Detalhes da Fatura</h3>
        <div className="text-center py-8 sm:py-12">
          <Calendar className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3" style={{ color: "var(--text-dimmed)" }} />
          <p className="text-sm sm:text-base" style={{ color: "var(--text-dimmed)" }}>Selecione um cartão para ver a fatura</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="backdrop-blur rounded-xl sm:rounded-2xl p-4 sm:p-6 transition-colors duration-300" style={cardStyle}>
        ...
        <div className="text-center py-6 sm:py-8">
          ...
          <p className="text-xs sm:text-sm" style={{ color: "var(--text-dimmed)" }}>Nenhum lançamento neste cartão</p>
          <p className="text-[10px] sm:text-xs mt-1" style={{ color: "var(--text-dimmed)" }}>Clique em &quot;Nova Compra&quot; para adicionar</p>
        </div>
      </div>
    );
  }
    ...
    <div className="backdrop-blur rounded-2xl p-4 sm:p-6 transition-colors duration-300" style={cardStyle}>
      ...
      <div>
        ...
        {!selectedInvoice.purchases || selectedInvoice.purchases.length === 0 ? (
          <div className="text-center py-6 sm:py-8">
            <ShoppingBag className="w-8 h-8 sm:w-10 sm:h-10 mx-auto mb-2" style={{ color: "var(--text-dimmed)" }} />
            <p className="text-xs sm:text-sm" style={{ color: "var(--text-dimmed)" }}>Nenhum lançamento nesta fatura</p>
          </div>
        ) : (
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2 text-[10px] sm:text-xs flex-wrap" style={{ color: "var(--text-dimmed)" }}>
                      ...
                      {purchase.isRecurring && (
                        <>
                          <span className="hidden sm:inline">•</span>
                          <span className="hidden sm:inline text-blue-400">Recorrente</span>
                        </>
                      )}
                    </div>
                  </div>
